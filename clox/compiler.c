...
static void call(bool __unused canAssign) {
    uint8_t argCount = argumentList();
    emitBytes(OP_CALL, argCount);
}

static void subscript(bool __unused canAssign) {
    expression();
...
static void super_(bool __unused canAssign) {
...
static void this_(bool __unused canAssign) {
    if (currentClass == NULL) {
...
ParseRule rules[] = {
        ...
        { NULL,     subscript,  PREC_CALL },       // TOKEN_LEFT_BRACKET
